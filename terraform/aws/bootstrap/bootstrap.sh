...
echo ""
echo "  NOTE: teardown of this identity layer is LOCAL-only — provision-aws.yml"
echo "  'destroy' would delete the very role it authenticates with. Destroy with:"
echo "    terraform destroy -target=module.github_oidc -var-file=terraform.tfvars"
