...
Created per namespace when the `circleguard-infra` chart is deployed (`deploy-data-plane.yml`); runtime values are synced from AWS Secrets Manager via External Secrets Operator.
